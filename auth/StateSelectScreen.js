        ...
        >
          <View style={styles.formContainer}>
            ...
            <View style={styles.logoCircle}>
              <Ionicons name="location-outline" size={24} color="#faf5ff" />
            </View>
            ...
            <View style={styles.headerBlock}>
              ...
              <Text style={styles.formSubtitle}>Choose your state to continue</Text>
            </View>
            ...
            <View style={styles.inputGroup}>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.8}
              >
                <Ionicons name="location-outline" size={18} color="#a78bfa" />
                <Text style={[styles.input, !state && { color: '#64748b' }]}>
