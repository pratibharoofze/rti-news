          ...
          {['A', 'B', 'C', 'D'].map((opt) => {
            ...
            return (
              <TouchableOpacity
                key={opt}
                style={[
                  AttemptQuizStyles.optionBtn,
                  isSelected && AttemptQuizStyles.optionBtnSelected,
                ]}
                onPress={() => handleSelectAnswer(opt)}
              >
                <View
                  style={[
                    AttemptQuizStyles.optionLabel,
                    isSelected && AttemptQuizStyles.optionLabelSelected,
                  ]}
                >
                  <Text
                    style={[
                      AttemptQuizStyles.optionLabelText,
                      isSelected && AttemptQuizStyles.optionLabelTextSelected,
                    ]}
                  >
                    {opt}
                  </Text>
                ...
                <Text
                  style={[
                    AttemptQuizStyles.optionText,
                    isSelected && AttemptQuizStyles.optionTextSelected,
                  ]}
                >
                  {optionText}
                </Text>
